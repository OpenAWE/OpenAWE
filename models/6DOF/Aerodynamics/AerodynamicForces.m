function [F_AeroBody] = AerodynamicForces( alpha, ...
                                           beta, ...
                                           airspeed, ...
                                           bodyAngularRate, ...
                                           coefficients, ...
...
phat                        = 0.5 * wingSpan / airspeed * bodyAngularRate(1);
qhat                        = 0.5 * chord / airspeed * bodyAngularRate(2);
rhat                        = 0.5 * wingSpan / airspeed * bodyAngularRate(3);
...
F_AeroBody                  = [FX_BODY; FY_BODY; FZ_BODY];
