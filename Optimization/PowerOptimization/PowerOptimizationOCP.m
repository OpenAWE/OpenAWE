classdef PowerOptimizationOCP < OclOCP
  ...
  methods (Static)
    function cost = discreteCost(self,nlpVars)
      ...
      pTraj = nlpVars.states.positionNav;
      cost = 0;
      for k=1:self.N+1
    ...
    function pathCosts(self,state,algState,controls,time,endTime,params)
      ...
      windNavAtAltitude = GetWindAtAltitude(PowerOptimizationOCP.system.modelParams.wind, ...
                                            positionNav);
    ...
    function pathConstraints(self,state,time,params)    
